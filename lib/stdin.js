...
var tools = require('./tools.js'),
    ...
    stdin = {
        ...
        debug: function(){
            var args = ['log'], i;
            for(i in arguments){ // eslint-disable-line guard-for-in
        ...
        if(argv.length > 1){
            switch(argv[1]){
                ...
                case'socket':
                    ...
                    break;
                case'memory':
                    var mem = process.memoryUsage(); // eslint-disable-line one-var, block-scoped-var
            ...
            var serv, // eslint-disable-line one-var
                ...
                mem = process.memoryUsage(); // eslint-disable-line no-redeclare, blocked-scope-var
            if(servers.length > 0){
